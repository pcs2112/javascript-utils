...
var getPopupDimensions = function getPopupDimensions(provider) {
  ...
  var _getPopupOffset = getPopupOffset({
    width: width,
    height: height
  }),
...
var _default = function _default(provider, url) {
  var name = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : '_blank';
  return window.open(url, name, provider !== 'newTab' ? "".concat(settings, ",").concat(getPopupDimensions(provider)) : '');
};
