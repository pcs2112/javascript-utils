...
exports.toCamel = exports.toUnderscore = exports.toDash = exports.shorten = exports.isMaxLength = exports.isMinLength = exports.hasSpecialChars = exports.convertToSlug = exports.hasNumbers = exports.ucwords = exports.replaceArray = exports.rtrim = exports.ltrim = exports.trim = exports.ucfirst = undefined;
 ...
 * @returns {String}
 */
var toDash = exports.toDash = function toDash(value) {
 ...
 * @returns {String}
 */
var toUnderscore = exports.toUnderscore = function toUnderscore(value) {
  return value.replace(/([A-Z])/g, function ($1) {
 ...
 * @returns {String}
 */
var toCamel = exports.toCamel = function toCamel(value) {
  return value.replace(/(-[a-z])/g, function ($1) {
