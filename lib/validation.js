...
var defaultMessages = {
  ...
  passwordValidator: '\n  Password needs to have {specialCharsLength} special character(s), at least {numbersLength} number(s), and needs to be \n  a minimum length of {passwordLength} character(s) or longer\n  '
};
 ...
 * @param {String} msg
 */
var passwordValidator = exports.passwordValidator = function passwordValidator(specialCharsLength, numbersLength, passwordLength, msg) {
  return function (value) {
    var error = '';
    var specialCharsValidation = specialCharsRequired(specialCharsLength);
    var numbersLengthValidation = numbersRequired(numbersLength);
    var passwordLengthValidation = minLength(passwordLength);
    if (specialCharsValidation(value) || numbersLengthValidation(value) || passwordLengthValidation(value)) {
      error = (0, _string.replaceArray)(msg || defaultMessages.passwordValidator, ['{specialCharsLength}', '{numbersLength}', '{passwordLength}'], [specialCharsLength, numbersLength, passwordLength]);
    }
    return error;
  };
};