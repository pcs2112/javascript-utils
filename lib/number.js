...
exports.getTotalPagesFromLimit = exports.getCurrentPageFromOffset = exports.getRandomNumber = exports.calculateEarnings = exports.calculateCubicFeet = exports.calculateSquareFeet = exports.almostEqual = exports.normalizeInputToFloat = exports.normalizeInputToInteger = exports.isNumber = undefined;
 ...
 * @return {Number}
 */
var getCurrentPageFromOffset = exports.getCurrentPageFromOffset = function getCurrentPageFromOffset(offset, total) {
  return total < 1 ? 1 : Math.ceil(offset / total);
};
...
var getTotalPagesFromLimit = exports.getTotalPagesFromLimit = function getTotalPagesFromLimit(limit, total) {
  return total < 1 ? 0 : Math.ceil(limit / total);
};