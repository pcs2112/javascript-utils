...
exports.formatCreditCardNumber = exports.truncateText = exports.textToHtml = exports.linkify = exports.formatPhoneNumber = exports.formatSecondsToTime = exports.formatBytes = exports.formatAddress = exports.formatCurrency = exports.formatNumber = undefined;
...
var formatCreditCardNumber = exports.formatCreditCardNumber = function formatCreditCardNumber(creditCardNumber) {
  var result = ('' + creditCardNumber).trim().slice(-4);
  if (result.length !== 4) {
    return '';
  }
